namespace FMS_API.Models
{
    public class T_OIHMAIN
    {
        ...
        public float? F_Pkgs { get; set; }
        public string? F_Punit { get; set; }
        public float? F_CBM { get; set; }
        public float? F_KGS { get; set; }
        public float? F_LBS { get; set; }
        ...
        public string? F_SManID { get; set; }
        ...
        public string? F_SelectContainer { get; set; }
        public string? F_MoveType { get; set; }
        public string? F_Nomi { get; set; }
        public string? F_IMemo { get; set; }
        public string? F_PMemo { get; set; }
        public float? F_DefaultRate { get; set; }
        public int? F_INVOICETO { get; set; }
        public string? F_DoorMove { get; set; }
